...
public class CamBehavior : MonoBehaviour, ICameraShake
{
    ...
    void Start()
    {
        m_offset = m_cameraTransform.position - m_characterManager.transform.position;
    ...
    {
        Vector3 targetPosition = m_characterManager.transform.position + m_characterManager.transform.forward;
